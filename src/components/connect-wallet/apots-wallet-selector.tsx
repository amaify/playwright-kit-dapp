                ...
                {hasPetraWebWallets && (
                    <div className="flex flex-col gap-2 pt-3">
                        {petraWebWallets.map((wallet) => (
                            <PetraWebWalletRow key={wallet.name} wallet={wallet} onConnect={close} />
                        ))}
    ...
    return (
        <>
            <DialogHeader className="grid grid-cols-[1fr_4fr_1fr] items-center space-y-0">
                ...
                <DialogTitle className="leading-snug text-base text-center">About Petra Web</DialogTitle>
            </DialogHeader>

            <div className="flex h-40.5 pb-3 items-end justify-center">
                <screen.Graphic />
            </div>
